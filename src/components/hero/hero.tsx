'use client'
import { fadeIn, slideInFromBottom, slideInFromLeft, slideInFromTop } from '@/utils/motion'
        ...
        >
          ...
          <motion.div className="flex w-full flex-col items-center gap-2">
            <div className="flex flex-col items-center md:items-start">
              <motion.h1 variants={slideInFromTop(0.2)} className="mx-1 text-5xl md:text-6xl">
                {t('title-h1')}
              </motion.h1>
              <motion.h2 variants={slideInFromLeft(0.5)} className="mx-2 text-2xl md:text-3xl">
                {t('title-h2')}
              </motion.h2>
              <motion.h3
